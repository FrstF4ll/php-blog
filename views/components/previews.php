...
<article id="<?= $post->id ?>"
    ...
    <div class="flex items-center justify-between w-full mt-4 p-1">
        <div class="flex items-center gap-x-4 text-xs">
            ...
            <p class="relative z-10 rounded-full bg-gray-100 px-3 py-1.5 font-medium hover:bg-gray-200 text-indigo-600 hover:text-indigo-700" style="background-color: <?= $post->cat_color ?>; color: <?= $post->cat_text_color ?>;">
