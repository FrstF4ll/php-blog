...
<article class="flex max-w-xl flex-col items-start justify-between relative">
    ...
    <?php endif; ?>
    <img class="rounded-lg w-full object-cover" src="assets/workflow.png" alt="workflow">
    ...
    <div class="relative mt-8 flex items-center gap-x-4 justify-self-end">
        <img src="assets/profile.svg" alt="profile picture" class="h-10 w-10 rounded-full bg-gray-100">
        <div class="text-sm/6">
